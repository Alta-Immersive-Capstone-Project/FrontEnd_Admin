...
function ManageKota() {
  ...
  useEffect(() => {
    axios
      ...
      .then((data) => {
        ...
        axios
          .get("http://18.136.202.111:8000/districts/3", {
            headers: {
  ...
  const updateDistrict = () => {
    ...
    axios
      .put(`http://18.136.202.111:8000/districts/3`, body, {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((data) => {
        handleCloseUpdate();
          ...
          <div className="col-12">
            ...
            <div className="d-flex my-2 gap-2">
              ...
              <Button
                ...
                disabled={addCity === "City" ? true : false}
              >
                Edit
              </Button>
              <Button
              ...
              <Button
                className="btn-manage"
                onClick={handleShowCreateDistrict}
                disabled={addCity === "City" ? true : false}
              >
                Add District
              </Button>
              ...
              <tbody className="text-center">
                <tr>
                  ...
                  <td>
                    <Button
                      variant="warning"
                      onClick={handleShowUpdateDistrict}
                    >
                      Edit
                    </Button>
